// --- EFHW 100W "Baitcaster" PETG EDITION V16 ---
// Fixes: Cap Alignment Slot, Rear Hub Vents, Binding Post Seat.
...
// 3. THE MASTER CAP (PETG with Slot)
module master_cap() {
    translate([flange_d + 40, 0, 0]) {
        difference() {
            ...
            translate([22, 0, -1]) cylinder(d = 9.8, h = wall + 2); 
